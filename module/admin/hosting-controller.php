...
class HostingController extends ClassController{
    ...
    function addVpsAction(){
        $this->loadViewFile(__FUNCTION__);
    }

    function viewVpsAction(){
        $this->loadViewFile(__FUNCTION__);
    }

    function listVps2Action($paramInput = null){
        $this->loadViewFile(__FUNCTION__);
    }

    function listVpsAction($paramInput = null){

        $this->loadViewFile(__FUNCTION__);
    }

    function listIpAction($paramInput = null){
